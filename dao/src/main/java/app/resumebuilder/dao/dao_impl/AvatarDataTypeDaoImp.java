...
import app.resumebuilder.dao.entity.model.AvatarDataType;
...
public class AvatarDataTypeDaoImp implements AvatarDataTypeDao {
    ...
    @Autowired
    public AvatarDataTypeDaoImp(DataConverter dataConverter) {
    ...
    public List<AvatarDataTypeDTO> findAll() {
        return entityManager.createQuery(SELECT, AvatarDataType.class)
                .getResultList()
                .stream()
