...
import app.resumebuilder.dto.PersonalDataTypeDTO;
import app.resumebuilder.eurekaclientmodel.model.PersonalDataType;
...
public class PersonalDataTypeDaoImp implements PersonalDataTypeDao {
    ...
    public List<PersonalDataTypeDTO> findAll() {
        return entityManager.createQuery(SELECT, PersonalDataTypeDTO.class)
                .getResultList()
                .stream()
    ...
    public void saveImage(PersonalDataTypeDTO personalDataTypeDTO, File file) {
        PersonalDataType entity = entityManager.find(
                PersonalDataType.class, personalDataTypeDTO.getId()
        );
